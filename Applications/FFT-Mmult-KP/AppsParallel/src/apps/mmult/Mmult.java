...
public class Mmult extends Runner implements MmultInterface {
	...
	public void run() {
		...
		Matrix a = new Matrix(task, rec, loop, 1.0f, false); // a is row-wise
																// flipped, to
																// make product
																// zero
	...
	//
	// MatrixMod a = new MatrixMod(task, rec, loop, 1.0f, false); // a is
	// row-wise flipped, to make product zero
