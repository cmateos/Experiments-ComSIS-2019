...
//				Log.d("Kna",Long.toString(System.currentTimeMillis()-time));
		...
		escribir("Medicion manual Knapsack modificada");
	}
	...
	public ReturnMod spawn_try_it(int i, int tw, int av, int limw, int maxv, int[] values, int[] weights, byte[] s, byte[] opts) {
